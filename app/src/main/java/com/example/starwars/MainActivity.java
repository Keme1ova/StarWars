...
public class MainActivity extends AppCompatActivity {
    ...
    TransformerRed robot1 = new TransformerRed ( "SuperWomen", ener1, las1, "I WON!");
    TransformerYellow robot2 = new TransformerYellow("Men", ener2, las2, "I WON!");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_lasers1 = binding.tvLaser1;
        tv_lasers2 = binding.tvLaser2;
        ...
        imagesRobotsLayout = binding.imagesRobotsLayuot;
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                binding.tvLaser1.setText(String.valueOf(robot1.getNum_lasers()));

                binding.tvEnergy2.setText(String.valueOf(robot2.getEnergy()));
                binding.tvLaser2.setText(String.valueOf(robot2.getNum_lasers()));
        ...
        btnFight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                binding.imagesRobotsLayuot.setVisibility(View.INVISIBLE);
    ...
    private void resetGame() {
        ...
        robot1 = new TransformerRed("SuperWomem", ener1, las1, "I won! It's my planet!");
        robot2 = new TransformerYellow("Men", ener2, las2, "I WON!");
